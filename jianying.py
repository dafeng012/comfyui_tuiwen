...
from godian import tracks, segment_video,segment_audio,vocal,videos_items,sound_items,speeds_items,canvases_items,beats_items,audios,draft_materials_items,material_animations_items,text_items,text_segment_items
...
class main:
    def init_data(self):
        ...
        self.folder_path = "D:/jianying-caogao/JianyingPro Drafts/我是ggg"  # 草稿文件夹路径
        self.novel_name = "我是ggg"  # 草稿名字
